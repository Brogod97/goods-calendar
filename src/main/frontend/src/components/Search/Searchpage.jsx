...
const Searchpage = ({ onClose }) => {
  ...
  return (
    <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full z-40">
      <div className="">
        <div
          id="searchpage"
          className="animate__animated animate__fadeInRight bg-white h-screen p-4"
        >
